...
export const AgentBuilderDemo: React.FC<AgentBuilderProps> = ({ onAgentCreated }) => {
  ...
  const handleTest = async (testData: any) => {
    ...
    try {
      ...
      notification.error({ message: 'Test failed', description: (error as Error).message });
    }
  };
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      notification.error({ message: 'Failed to create agent', description: (error as Error).message });
    }
  };
...
export default AgentBuilderDemo; 